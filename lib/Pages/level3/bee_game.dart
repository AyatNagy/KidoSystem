...
import'package:kido/Models/level3/tracing_bee.dart';
import'package:audioplayers/audioplayers.dart';
import'package:lottie/lottie.dart';

class BeeGame extends StatefulWidget {
  final TracingQuestion question;
  BeeGame({required this.question});

  @override
  _BeeGameState createState() => _BeeGameState();
}

class _BeeGameState extends State<BeeGame> {
  int gameStage=1; 
  bool isVisible=true;
