...
import 'package:kido/data/number_lesson_english_data.dart';
import 'package:kido/Widgets/content/level3/numbers_lesson_widget.dart'; // Make sure you have this widget
...
class _EnglishNumberLessonState extends State<EnglishNumberLesson> {
  ...
  Widget build(BuildContext context) {
    ...
    final lessons = NumbersEnglishLessonRepo.numbersEnglessons;
