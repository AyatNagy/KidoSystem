...
import 'package:kido/Models/bodyParts_button.dart';
...
class _BodyPartsScreenState extends State<BodyPartsScreen> with TickerProviderStateMixin  {
  ...
  void goNext(){
    if(widget.index<bodyParts.length-1){
      Navigator.pushReplacement(context,MaterialPageRoute(builder: (_)=>BodyPartsScreen(index: widget.index+1),
      ),
      );
    }else{
