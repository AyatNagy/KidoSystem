...
import 'package:kido/Widgets/content/level2/angry_character.dart';
import 'package:kido/Widgets/content/level2/sad_character.dart';
...
class _EmotionsPageViewState extends State<EmotionsPageView> {
  ...
  final List<EmotionScreen> emotions = [
    ...
    EmotionScreen(
      ...
      background: "",
      characterWidget: const SadCharacter(),
    ...
    EmotionScreen(
      ...
      background: "",
      characterWidget: const AngryCharacter(),
