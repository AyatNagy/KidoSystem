...
class _DrawingState extends State<Drawing> {
  ...
  Widget build(BuildContext context) {
    ...
    // نستخدم Scaffold عشان نضمن إن الخلفية بيضاء تماماً
    return Scaffold(
      backgroundColor: Colors.white,
      body: Container(
        // تأكيد إضافي بتلوين الـ Container
        color: Colors.white,
        child: Stack(
          children: [
            GestureDetector(
            ...
            // شريط اختيار الألوان (موجود كما هو في كودك)
            Positioned(
            ...
            // نص التعليمات (موجود كما هو في كودك)
